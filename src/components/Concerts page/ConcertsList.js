...
import {url, baseurl} from '../../services/services'
...
const ConcertsList = ({cityid, singerid}) => {
        ...
        if (choice) {
            ...
            const getdata2 = async () => {
                ...
                const options = {
                    ...
                    params: {take: 4, type: 1, singer_id: singerid, city_id: choice.id, search: search}
                };
                setLoading(true)
            ...
            content = data.items.map((item) => (
                <>
                    ...
                    <ConcertCard key={item.concerts.id} image={`${baseurl}/${item.concerts.img}`}
                                 ...
                                 ts={item.concerts.date} city={item.cities.name}/>
